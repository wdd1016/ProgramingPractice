...
static void	update_rev(int start, int end, int index, int left, \
int right, int *tree, int *lazy);
static int sum_tree(int start, int end, int index, int left, \
int right, int *tree, int *lazy);
static void update_lazy(int start, int end, \
...
static void	update_rev(int start, int end, int index, int left, int right, int *tree, \
